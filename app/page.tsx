...
export default function Home() {
    ...
    content: (
      <div>
        <p className="mb-8 text-xs font-normal text-neutral-800 md:text-sm dark:text-neutral-200">
          We start with smart profiling — no long forms, just a few thoughtful
          questions. 🧠 Inputs:
        </p>
        <div className="mb-8">
          <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
            ✅ Your interests, skills, education
          </div>
          <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
            ✅ Work preferences & personality cues
          </div>
          <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
            ✅ Career goals or confusion points
          </div>
        </div>
  ...
  },
  {
    ...
    content: (
      <div>
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
            ✅ 1000+ real-world career paths
          </div>
          <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
            ✅ Emerging job trends, salary data
          </div>
          <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
            ✅ Your current profile and potential trajectory
          </div>
        </div>
        <p className="mb-8 text-xs font-normal text-neutral-800 md:text-sm dark:text-neutral-200">
          Outcome: A personalized shortlist of high-fit careers — not just
          popular ones.
        </p>
        <div className="grid grid-cols-2 gap-4">
          <img
  ...
  },
  {
    ...
    content: (
      <div>
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
            ✅ Roadmap with skills to learn
          </div>
          <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
            ✅ Estimated time to switch/enter
          </div>
          <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
          ...
          <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
            ✅ Job market trends for that role
          </div>
        </div>
        <div className="grid grid-cols-2 gap-4">
          <img
  ...
  },
  {
    ...
    content: (
      <div>
        <p className="mb-4 text-xs font-normal text-neutral-800 md:text-sm dark:text-neutral-200">
          Careers aren’t linear — and neither is PathFinder. You can:
        </p>
        <div className="mb-8">
          <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
          ...
          <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
            ✅ Get new insights as your profile evolves
          </div>
          <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
            ✅ See alternate paths if your goals shift
          </div>
        </div>
        <div className="grid grid-cols-2 gap-4">
          <img
   ...
   <div className="h-[40rem] w-full rounded-md flex md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden">
        ...
        <div className=" p-4 max-w-7xl  mx-auto relative z-20  w-full pt-20 md:pt-0">
          ...
          <p className="mt-6 font-normal text-base text-neutral-300 max-w-lg text-center mx-auto">
            PathFinder is your quiet, intelligent career companion — no
      ...
      <div className="relative flex h-[35rem] w-full items-center justify-center bg-white dark:bg-black">
        ...
        <div className="flex flex-col justify-start items-center lg:w-[697px] gap-[20px] max-lg:px-2">
          <p className="relative z-20 text-center font-inter text-white text-[20px] lg:text-[30px] xl:text-[34px] font-semibold tracking-tight">
            Get career-ready with PathFinder - it’s free
          </p>
          <p className="text-center font-inter tracking-tight text-[16px] text-[#A19DAE]">
            ...
            mastering interviews, everything here is built to help you succeed —
